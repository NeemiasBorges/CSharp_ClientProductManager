...
{
    partial class ClienteAddEdit
    {
        public int Temporary_id = 0;
        /// <summary>
        ...
        /// </summary>
        private void InitializeComponent(Aplicacao.DTO.ClienteDTO cliente)
        {
            Temporary_id = cliente.Id;
            ...
            txtBx_nome = new TextBox();
            txtBx_endereco = new TextBox();
            ...
            // txtBx_nome
            // 
            txtBx_nome.Location = new Point(186, 62);
            txtBx_nome.Name = "txtBx_nome";
            txtBx_nome.Size = new Size(319, 27);
            txtBx_nome.TabIndex = 5;
            txtBx_nome.Text = cliente.Nome ?? "";
            // 
            // txtBx_endereco
            // 
            txtBx_endereco.Location = new Point(186, 119);
            txtBx_endereco.Name = "txtBx_endereco";
            txtBx_endereco.Size = new Size(319, 27);
            txtBx_endereco.TabIndex = 6;
            txtBx_endereco.Text = cliente.vlrEndereco ?? "";
            // 
            // txtBx_email
            // 
            txtBx_email.Location = new Point(186, 173);
            txtBx_email.Name = "txtBx_email";
            txtBx_email.Size = new Size(319, 27);
            txtBx_email.TabIndex = 7;
            txtBx_email.Text = cliente.Email ?? "";
            // 
            // lblDesc
            // 
            ...
            metroSetLabel1.Location = new Point(55, 224);
            ...
            metroSetLabel1.Text = "Telefone";
            metroSetLabel1.ThemeAuthor = "Narwin";
            metroSetLabel1.ThemeName = "MetroLite";
            // 
            // txtBx_telefone
            // 
            txtBx_telefone.Location = new Point(186, 224);
            txtBx_telefone.Name = "txtBx_telefone";
            txtBx_telefone.Size = new Size(319, 27);
            txtBx_telefone.TabIndex = 10;
            txtBx_telefone.Text = cliente.vlrTelefone ?? "";
            // 
            // ClienteAddEdit
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(562, 412);
            Controls.Add(metroSetLabel1);
            Controls.Add(txtBx_telefone);
            Controls.Add(lblPreco);
            Controls.Add(lblDesc);
            Controls.Add(txtBx_email);
            Controls.Add(txtBx_endereco);
            Controls.Add(txtBx_nome);
        ...
        private TextBox txtBx_nome;
        private TextBox txtBx_endereco;
        ...
        private TextBox txtBx_telefone;
    }
}